                            ...
                            (post) => (
                                <Table.Body className="divide-y">
                                    <Table.Row className=" bg-white dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <Table.Cell>
                                            <span className="font-medium text-red-500 hover:underline hover:cursor-pointer">Delete</span>
                                        </Table.Cell>
                                        <Table.Cell>
                                            <Link to={`/update-post/${post._id}`}>
                                                <span className="text-teal-500 hover:underline hover:cursor-pointer">Edit</span>
                                            </Link>
                                        </Table.Cell>
                                    </Table.Row>
                                </Table.Body>
